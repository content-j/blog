...
public class Utility {
	 ...
	 * @return 페이징 생성 문자열
	 */
	public static String paging(String noname , int totalRecord, int nPage, int recordPerPage, String url, int bbsno, int nowPage,
		...
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&"+noname+"=" + bbsno + "&nPage=" + _nowPage + "'>이전</A></span>");
		}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (nPage == i) {
				...
				str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col
						+ "&word=" + word + "&"+noname+"=" + bbsno + "&nPage=" + i + "'>" + i + "</A></span>");
			}
		}
		...
		if (nowGrp < totalGrp) {
			str.append("<span class='span_box_1'><A href='./" + url + "?nowPage=" + nowPage + "&col=" + col + "&word="
					+ word + "&"+noname+"=" + bbsno + "&nPage=" + _nowPage + "'>다음</A></span>");
		}
		str.append("</DIV>");
	...
	public static String paging3(int totalRecord, int nowPage, int recordPerPage, String col, String word) {
		...
		int _nowPage = (nowGrp - 1) * pagePerBlock; // 10개 이전 페이지로 이동
		if (nowGrp >= 2) {
			str.append("<span class='span_box_1'><A href='./list?col=" + col + "&word=" + word + "&nowPage=" + _nowPage
					+ "'>이전</A></span>");
		}
