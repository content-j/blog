			...
			<table border="1">
				...
				<tr>
					...
					<th><input type="text" name="zipcode" size="40%"
						...
						<input type="text" name="address1" size="60%" id="sample6_address"
						placeholder="주소"> <input type="text" name="address2"
						size="80%" id="sample6_address2" placeholder="상세주소"></th>
				</tr>

				<tr>
					<td>보유기술</td>
					<th><label for="s1"> <input id="s1" type="checkbox"
							name="skill" value="Java">Java
